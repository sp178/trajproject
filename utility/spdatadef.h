...
const double Constant_Earth_GM = 3.986005E+14;		  // 地心引力常数   (m^3/s^2)
const double Constant_Earth_J2 = 1.08263E-3;		  // 动力形状因子
const double Constant_Earth_RA = 6378140;			  // 地球长半轴	  (m)
const double Constant_Earth_RP = 6356755.28856;		  // 地球短半轴	  (m)
const double Constant_Earth_Rm = 6371003.7814;		  // 地球平均半径   (m)
const double Constant_Earth_Rae = 6378140;			  // 地球赤道半径   (m)
const double Constant_Earth_Alpha = 0.00335281311553; // 地球扁率
const double Constant_Earth_g0 = 9.80665;			  // 标准重力加速度 (m/s^2)
const double Constant_Earth_We = 7.292115E-5;		  // 地球自旋角速度 (rad/s)
const double Constant_Earth_e2 = 6.69438487525E-3;	// 第一偏心率的平方
const double Constant_Earth_Ae = 0.00335281311553;	// 地球扁率
